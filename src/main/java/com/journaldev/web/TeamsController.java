...
public class TeamsController {
	...
	private static List<Team> teamsHeroku = new ArrayList<Team>();
	...
	@RequestMapping(value = "/champions-heroku", method = RequestMethod.GET)
	public String championsSimulatorHeroku(Model model) {
		// Define the form
		TeamForm teamForm = new TeamForm();
		if(teamsHeroku.isEmpty()){
		teamsHeroku.add(teamManager.getTeamById(17));
		teamsHeroku.add(teamManager.getTeamById(18));
		teamsHeroku.add(teamManager.getTeamById(19));
		teamsHeroku.add(teamManager.getTeamById(20));
		teamsHeroku.add(teamManager.getTeamById(21));
		teamsHeroku.add(teamManager.getTeamById(22));
		teamsHeroku.add(teamManager.getTeamById(23));
		teamsHeroku.add(teamManager.getTeamById(24));
		teamsHeroku.add(teamManager.getTeamById(25));
		teamsHeroku.add(teamManager.getTeamById(26));
		teamsHeroku.add(teamManager.getTeamById(27));
		teamsHeroku.add(teamManager.getTeamById(28));
		teamsHeroku.add(teamManager.getTeamById(29));
		teamsHeroku.add(teamManager.getTeamById(30));
		teamsHeroku.add(teamManager.getTeamById(31));
		teamsHeroku.add(teamManager.getTeamById(32));			
	}
	

	// Add the list of teams to the form
	teamForm.setTeams(teamsHeroku);
	// Add the form
	model.addAttribute("teamForm", teamForm);
	return "champions/heroku";
