...
<body>
    ...
    <div class="container">
        ...
        <a href="https://devcenter.heroku.com/articles/request-timeout">Heroku has a 30 s request timeout.</a> 
        As calculations with 8 groups takes longer than this time, I have included this section only for demonstrative purposes.
        Run the application locally so that you can get your own chances.
